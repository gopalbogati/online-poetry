...
$config = array(
    ...
    |
    */
    'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && !in_array(strtolower($_SERVER['HTTPS']),
                array('off', 'no'))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'],
    ...
    */
    ...
    'access_keys' => array('lB2PK8fl735R7xM849MA50UHFJXpID38'),
    ...
    */
    ...
    // only create files with exts. defined in $editable_text_file_exts
     ...
     *******************/
    'aviary_active' => true,
    'aviary_apiKey' => "663dba579fbf4f2fa0dd8ff190796a37",
    'aviary_language' => "en",
    'aviary_theme' => "light",
    'aviary_tools' => "all",
    'aviary_maxSize' => "1400",
