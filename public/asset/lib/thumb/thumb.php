<?php
/**
 *thumb.php?src=castle1.jpg&h=180&w=120
...
if(! defined('FILE_CACHE_DIRECTORY') )          define ('FILE_CACHE_DIRECTORY', './images/thumbnails');             // Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
