...
<div class="banner">
    <div class="container">
        <div class="header">
            <div class="logo">
                <a href="index.html"><img src="{{asset('web/images/logo.png')}}"  class="img-responsive" alt="" /></a>
            </div>
                        ...
                        <div class="col-md-3 praesent">
                            <div class="l_g_r">
                                <div class="dapibus">
                                    <h3>CURSUS FAUCIO</h3>
                                    <p class="adm">Posted by <a href="#">Admin</a>  |  7 days ago</p>
                                    <a href="details.html"><img src="{{asset('web/images/img2.jpg')}}" class="img-responsive" alt=""></a>
                        ...
                        <div class="col-md-3 praesent">
                            <div class="l_g_r">
                                <div class="dapibus">
                                    <h2>Praesent dapibusneque id cursus faucioibus tortor neque tiegetas augue</h2>
                                    <p class="adm">Posted by <a href="#">Admin</a>  |  7 days ago</p>
                                    <a href="details.html"><img src="{{asset('web/images/img10.jpg')}}"  class="img-responsive" alt=""></a>
                                    <p>Phasellus ultrices nulla quis nibh. Quisque a lectus. Donec consectetuer ligula vulputate. </p>
                                    <a href="details.html" class="link">Read More</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 integ">
                            <div class="l_g_r">
                                <div class="vitae">
                                    <h3>Integer vitae libero risus egestas</h3>
                                    <p class="adm">Posted by <a href="#">Admin</a>  |  7 days ago</p>
                                    <a href="details.html"><img src="{{asset('web/images/img4.jpg')}}" class="img-responsive" alt=""></a>
                        ...
                        <div class="col-md-3 praesent">
                            <div class="l_g_r">
                                <div class="integer">
                                    ...
                                    <p class="adm">Posted by <a href="#">Admin</a>  |  7 days ago</p>
                                    <a href="details.html"><img src="{{asset('web/images/img11.jpg')}}"  class="img-responsive" alt=""></a>
                                    <p>Phasellus ultrices nulla quis nibh. Quisque a lectus. Donec consectetuer ligula vulputate. </p>
                                    <a href="details.html" class="link">Read More</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 praesent">
                            <div class="l_g_r">
                                <div class="dapibus">
                                    <h2>Praesent dapibusneque id cursus faucioibus tortor neque tiegetas augue</h2>
                                    <p class="adm">Posted by <a href="#">Admin</a>  |  7 days ago</p>
                                    <a href="details.html"><img src="{{asset('web/images/img13.jpg')}}"  class="img-responsive" alt=""></a>
                                    <p>Phasellus ultrices nulla quis nibh. Quisque a lectus. Donec consectetuer ligula vulputate. </p>
                                    <a href="details.html" class="link">Read More</a>
                                </div>
                            </div>
